    ...
    def parse_content(self, content: str) -> ImportResult:
        ...
        try:
            ...
            if not isinstance(data, dict):
                result = ImportResult()
                result.parsing_errors.append("Invalid circuit-synth format: expected JSON object")
                return result
            ...
            if result.is_successful:
                ...
                logger.error(f"Circuit-synth parsing had critical errors: {result.parsing_errors}")
