...
class PowerAnalyzer(ValidationRule):
    ...
    def analyze_power(
        ...
        if results.analysis_type != "dc":
            raise NotImplementedError("Power analysis currently only supports DC analysis")
        ...
        power_budget = {
            ...
            'efficiency': total_dissipated / total_supplied if total_supplied > 0 else 0.0,
    ...
    def _get_component_voltage(self, component: Dict, results: SimulationResults) -> Optional[float]:
    ...
    def _get_component_current(self, component: Dict, results: SimulationResults, name: str) -> Optional[float]:
