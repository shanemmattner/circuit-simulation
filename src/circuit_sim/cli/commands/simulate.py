...
def dc(circuit_id: str, output: Optional[Path]):
    ...
    try:
            ...
            try:
                ...
                results_data = {
                    ...
                    "results": {
                        ...
                        "branch_currents": {"V1": 0.005},  # 5mA through 1k resistor
                    },
        ...
        console.print("\n💡 Next steps:")
        console.print(
            f"  • Generate report: [bold]circuit-sim report --results {output_file}[/bold]"
        )
    ...
    try:
        ...
        with Progress(
            ...
            results_data = {
                ...
                "circuit_name": metadata["name"],
                "parameters": {"duration": duration, "timestep": timestep},
                "status": "mock",
