...
from circuit_sim.cli.utils.output import print_info, print_error
...
def list_circuits():
    ...
    if not circuits:
        ...
        console.print("💡 Create a circuit with: [bold]circuit-sim create --netlist <file> --name <name>[/bold]")
        return
...
def circuit_info(circuit_id: str):
    ...
    try:
        ...
        if simulations:
            ...
            console.print(f"💡 Run simulation: [bold]circuit-sim simulate dc --circuit-id {circuit_id}[/bold]")
