...
class AnalysisTools:
    ...
    async def get_results(self, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if simulation_type == "dc":
            ...
            return self._format_transient_results(
                circuit_id, session.circuit.name, results
            )
        else:
            return {
                "status": "error",
    ...
    def _format_transient_results(
        ...
        if results.time is not None:
            time_data = {
                ...
                "step": (
                    float(results.time[1] - results.time[0])
        ...
        return {
            ...
            "results": {
                ...
                "summary": {
                    "duration": (
                        time_data["stop"] - time_data["start"] if time_data else 0
                    ),
    ...
    async def export_circuit(self, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if format_type == "json":
            ...
            netlist_lines = [
                f"* {circuit.name}",
                "* Generated by MCP Circuit Simulator",
                "",
            ]
