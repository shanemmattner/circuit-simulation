...
class AnalysisTools:
    ...
    def _format_dc_results(self, circuit_id: str, circuit_name: str, results) -> Dict[str, Any]:
        ...
        for component in results.components:
            ...
            if current is not None:
                branch_currents[f"I({component})"] = {"value": float(current[0]), "unit": "A"}
        ...
        for component in results.components:
            ...
            if current is not None and component.startswith("R"):
                ...
                power_dissipation[component] = {"current": float(current[0]), "unit": "A"}
    ...
    def _format_transient_results(
        self, circuit_id: str, circuit_name: str, results
    ) -> Dict[str, Any]:
    ...
    async def generate_plot(self, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "plot": {"format": "png", "encoding": "base64", "data": plot_data},
    ...
    async def export_circuit(self, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if format_type == "json":
            ...
            for comp in circuit.components:
                comp_dict = {"type": comp.component_type, "name": comp.name}
            ...
            netlist_lines = [f"* {circuit.name}", "* Generated by MCP Circuit Simulator", ""]

            for comp in circuit.components:
                if comp.component_type == "resistor":
                    netlist_lines.append(f"{comp.name} {comp.node1} {comp.node2} {comp.resistance}")
            ...
            return {"status": "success", "format": "netlist", "data": "\n".join(netlist_lines)}
