...
class TestRLCResonanceCircuit:
    ...
    def test_series_rlc_creation(self):
        ...
        circuit = RLCResonanceCircuit(
            r=10, l=1e-3, c=1e-6, topology="series", vin=1.0  # 10Ω  # 1mH  # 1µF
        )
    ...
    def test_parallel_rlc_creation(self):
        ...
        circuit = RLCResonanceCircuit(
            r=1000, l=10e-3, c=100e-9, topology="parallel"  # 1kΩ  # 10mH  # 100nF
        )
    ...
    def test_quality_factor_calculation(self):
        ...
        circuit_high_q = RLCResonanceCircuit(
            r=1, l=1e-3, c=1e-6, topology="series"  # Low resistance
        )

        # Low Q circuit
        circuit_low_q = RLCResonanceCircuit(
            r=100, l=1e-3, c=1e-6, topology="series"  # High resistance
        )
    ...
    def test_bandwidth_calculation(self):
        ...
        circuit = RLCResonanceCircuit(r=10, l=1e-3, c=1e-6, topology="series")
...
class TestRLCSimulation:
    ...
    def test_transient_response(self):
        ...
        results = simulate_rlc_circuit(
            circuit, analysis_type="transient", duration=1e-3, timestep=1e-6
        )
...
class TestResonancePlots:
    ...
    def test_nyquist_plot(self):
        ...
        fig = generate_resonance_plots(circuit, spectrum, plot_type="nyquist")
...
class TestRLCApplications:
    ...
    def test_notch_filter(self):
        ...
        circuit = RLCResonanceCircuit(r=1000, l=10e-3, c=100e-9, topology="parallel")
