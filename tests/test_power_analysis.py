...
class TestPowerAnalysisValidation:
    ...
    def test_high_power_component_warning(self):
        ...
        warning_found = any("high power" in w.message.lower() for w in power_analysis.warnings)
    ...
    def test_power_rating_validation(self):
        ...
        rating_error = any("rating" in e.message.lower() and "R1" in e.components for e in errors)
        assert rating_error
...
class TestPowerAnalyzerConfiguration:
    ...
    def test_custom_power_thresholds(self):
        ...
        analyzer_high = PowerAnalyzer(
            power_warning_threshold=200.0,
            power_error_threshold=500.0
        )
        ...
        analyzer_low = PowerAnalyzer(
            power_warning_threshold=10.0,
            power_error_threshold=50.0
        )
...
class TestIntegratedPowerAnalysis:
    ...
    def test_simulation_results_power_analysis(self):
        ...
        circuit.add_voltage_source("V1", 1, 0, "5V")  # Lower voltage to avoid exceeding threshold
    ...
    def test_power_analysis_with_ratings(self):
        ...
        rating_error = any("rating" in issue.message.lower() for issue in power_analysis.issues)
        assert rating_error