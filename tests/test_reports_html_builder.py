...
<body>
    ...
    def test_build_quick_report(self):
        ...
        report_data = {
            ...
            "summary": {"text": "This is a quick summary."},
        }
    ...
    def test_build_with_charts(self):
        ...
        report_data = {
            ...
            "charts": {"dc_voltages": mock_chart, "transient_voltages": mock_chart},
        }
    ...
    def test_chart_html_generation(self):
        ...
        mock_chart.to_html.assert_called_once_with(
            include_plotlyjs="cdn", div_id="chart-test_chart"
        )
    ...
    def test_error_handling_template_render(self):
        ...
        bad_templates = {"bad.html": "{{ undefined_variable.missing.method() }}"}
