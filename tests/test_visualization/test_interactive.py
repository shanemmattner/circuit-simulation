...
class TestInteractivePlotter:
    ...
    def test_interactive_nyquist_plot(self):
        ...
        assert isinstance(html_output, str)
        assert "nyquist" in html_output.lower() or "Interactive Nyquist Test" in html_output
    ...
    def test_interactive_smith_chart(self):
        ...
        assert isinstance(html_output, str)
        assert "smith" in html_output.lower() or "Interactive Smith Chart Test" in html_output
        assert len(html_output) > 500
    ...
    def test_plotly_export_configuration(self):
        ...
        assert "toImageButtonOptions" in html_output or "modeBarButtonsToAdd" in html_output
...
class TestPlotlyUtilities:
    ...
    def test_frequency_axis_formatting(self):
        ...
        from src.circuit_sim.visualization.interactive_plots import format_frequency_axis
    ...
    def test_smith_chart_data_preparation(self):
        ...
        gamma_mag = np.sqrt(np.array(smith_data["real"])**2 + np.array(smith_data["imag"])**2)
    ...
    def test_hover_template_generation(self):
        ...
        from src.circuit_sim.visualization.interactive_plots import create_hover_template
