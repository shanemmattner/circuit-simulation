...
class RLCResonanceCircuit:
    ...
    def _calculate_parameters(self):
        ...
        # Bandwidth
        self.bandwidth = self.resonant_frequency / self.q_factor if self.q_factor > 0 else float('inf')
    ...
    def transfer_function(self, frequency: float) -> complex:
        ...
        if self.topology == "series":
            ...
            h = (self.r*self.l*self.c*s**2) / (self.l*self.c*s**2 + self.l/self.r*s + 1)
    ...
    def characterize_circuit(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "damped_frequency": self.damped_frequency if self.damping_type == "underdamped" else None
        }
